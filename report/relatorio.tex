...
Apesar das sucessivas tentativas que foram feitas para que apenas o Player conseguisse fazer pedidos ao servidor nos endpoints "api/v1/player/*" através de certificados assinados pela CA do IEDCS, não foi possível a conclusão deste mesmo processo, pois quando se tentava fazer um pedido 
