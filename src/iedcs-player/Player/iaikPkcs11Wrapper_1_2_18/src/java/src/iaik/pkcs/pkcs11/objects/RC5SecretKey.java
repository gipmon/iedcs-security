...
public class RC5SecretKey extends SecretKey {
	...
	public RC5SecretKey() {
		super();
		keyType_.setLongValue(KeyType.RC5);
	}

	/**
	 * Called by getInstance to create an instance of a PKCS#11 RC5 secret
	 * key.
	 *
	 ...
	 * @postconditions
	 */
	protected RC5SecretKey(Session session, long objectHandle)
	 ...
	 * an instance of a PKCS#11 RC5 secret key.
	 *
	 * @param session The session to use for reading attributes.
	 *                This session must have the appropriate rights; i.e.
	 *                it must be a user-session, if it is a private object.
	 ...
	 * @preconditions
	 * @postconditions (result <> null)
	 *                 and (result instanceof RC5SecretKey)
