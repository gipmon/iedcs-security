...
/**
 * Objects of this class represent BATON secret keys as specified by PKCS#11
 * v2.11.
 *
...
public class BatonSecretKey extends SecretKey {
	...
	public BatonSecretKey() {
		super();
		keyType_.setLongValue(KeyType.BATON);
	}

	/**
	 * Called by getInstance to create an instance of a PKCS#11 BATON secret
	 * key.
	 *
	 ...
	 * @postconditions
	 */
	protected BatonSecretKey(Session session, long objectHandle)
	 ...
	 * an instance of a PKCS#11 BATON secret key.
	 *
	 * @param session The session to use for reading attributes.
	 *                This session must have the appropriate rights; i.e.
	 *                it must be a user-session, if it is a private object.
	 ...
	 * @preconditions
	 * @postconditions (result <> null)
	 *                 and (result instanceof BatonSecretKey)
