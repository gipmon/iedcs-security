...
/**
 * Objects of this class represent RC2 secret keys as specified by PKCS#11
 * v2.11.
 *
...
public class RC2SecretKey extends SecretKey {
	...
	public RC2SecretKey() {
		super();
		keyType_.setLongValue(KeyType.RC2);
	}

	/**
	 * Called by getInstance to create an instance of a PKCS#11 RC2 secret
	 * key.
	 *
	 ...
	 * @postconditions
	 */
	protected RC2SecretKey(Session session, long objectHandle)
	 ...
	 * an instance of a PKCS#11 RC2 secret key.
	 *
	 * @param session The session to use for reading attributes.
	 *                This session must have the appropriate rights; i.e.
	 *                it must be a user-session, if it is a private object.
	 ...
	 * @preconditions
	 * @postconditions (result <> null)
	 *                 and (result instanceof RC2SecretKey)
