...
/**
 * Objects of this class represent CAST secret keys as specified by PKCS#11
 * v2.11.
 *
...
public class CASTSecretKey extends SecretKey {
	...
	public CASTSecretKey() {
		super();
		keyType_.setLongValue(KeyType.CAST);
	}

	/**
	 * Called by getInstance to create an instance of a PKCS#11 CAST secret
	 * key.
	 *
	 ...
	 * @postconditions
	 */
	protected CASTSecretKey(Session session, long objectHandle)
	 ...
	 * an instance of a PKCS#11 CAST secret key.
	 *
	 * @param session The session to use for reading attributes.
	 *                This session must have the appropriate rights; i.e.
	 *                it must be a user-session, if it is a private object.
	 ...
	 * @preconditions
	 * @postconditions (result <> null)
	 *                 and (result instanceof CASTSecretKey)
