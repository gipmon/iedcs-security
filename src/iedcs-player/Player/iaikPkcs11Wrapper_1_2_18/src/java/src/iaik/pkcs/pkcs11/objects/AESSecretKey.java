...
/**
 * Objects of this class represent AES secret keys as specified by PKCS#11
 * v2.11.
 *
...
public class AESSecretKey extends SecretKey {
	...
	/**
	 * Called by getInstance to create an instance of a PKCS#11 AES secret
	 * key.
	 *
	 ...
	 * @postconditions
	 */
	protected AESSecretKey(Session session, long objectHandle)
