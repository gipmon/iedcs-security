...
/**
 * Objects of this class represent Triple-DES secret keys as specified by
 * PKCS#11 v2.11.
 *
...
public class DES3SecretKey extends SecretKey {
	...
	/**
	 * Called by getInstance to create an instance of a PKCS#11 Triple-DES secret
	 * key.
	 *
	 ...
	 * an instance of a PKCS#11 Triple-DES Secret key.
	 *
	 * @param session The session to use for reading attributes.
	 *                This session must have the appropriate rights; i.e.
	 *                it must be a user-session, if it is a private object.
	...
	public static Object getInstance(Session session, long objectHandle)
	    throws TokenException
	{
		return new DES3SecretKey(session, objectHandle);
	}
	 ...
	 * @preconditions
	 * @postconditions (result <> null)
	 *                 and (result instanceof DES3SecretKey)
	...
	public boolean equals(java.lang.Object otherObject) {
		...
		if (otherObject instanceof DES3SecretKey) {
