...
/**
 * Objects of this class represent SkipJack secret keys as specified by PKCS#11
 * v2.11.
 *
...
public class SkipJackSecretKey extends SecretKey {
	...
	/**
	 * Called by getInstance to create an instance of a PKCS#11 SkipJack secret
	 * key.
	 *
	 ...
	 * an instance of a PKCS#11 SkipJack secret key.
	 *
	 * @param session The session to use for reading attributes.
	 *                This session must have the appropriate rights; i.e.
	 *                it must be a user-session, if it is a private object.
	 ...
	 * @preconditions
	 * @postconditions (result <> null)
	 *                 and (result instanceof SkipJackSecretKey)
